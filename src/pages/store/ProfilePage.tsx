        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-display font-bold uppercase tracking-wider transition-all ${
                tab === "orders" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground"
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-display font-bold uppercase tracking-wider transition-all ${
                tab === "wishlist" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground"
              }`}
            >
