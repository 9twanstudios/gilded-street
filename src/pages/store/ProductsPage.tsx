...
export default function ProductsPage() {
  ...
  const [category, setCategory] = useState(searchParams.get("badge") ? "All" : "All");
    ...
    <div className="container py-8">
      ...
      <div className="flex gap-3 mb-4">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg border text-sm font-display font-semibold uppercase tracking-wider transition-all duration-200 ${
            ...
            <div className="bg-card rounded-lg border border-border p-5 mb-6 space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {PRICE_RANGES.map((range, i) => (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-full text-xs font-display font-semibold transition-all duration-200 ${
                        priceRange === i
                ...
                <div className="flex flex-wrap gap-2">
                  {allSizes.map((size) => (
                    <button
                      ...
                      className={`min-w-[2.5rem] h-8 px-2.5 rounded border text-xs font-display font-semibold transition-all duration-200 ${
              ...
              {activeFilterCount > 0 && (
                <button
                  ...
                  className="text-xs text-destructive hover:underline font-display font-semibold uppercase tracking-wider"
                >
                  Clear All Filters
                </button>
              )}
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-20">
          ...
          <button onClick={clearAllFilters} className="text-primary hover:underline text-sm font-display font-semibold uppercase tracking-wider">
            Clear Filters
          </button>
        </div>
      ) : (
